...
import 'package:food/features/account/screens/account_screen.dart';
import 'package:food/features/cart/screens/cart_screen.dart';
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Container(
              ...
              child: badges.Badge(
                badgeContent: Text(userCartLen.bitLength.toString()),
